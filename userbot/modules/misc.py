...
async def contributor(e):
    await e.edit("[CleanFlash](https://t.me/cleanflash)")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[OpenUserBot's README.md file](https://github.com/afdulfauzan/telegram-userbot/blob/stable/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "Click [HERE](https://github.com/afdulfauzan/telegram-userbot) to open Telegram UserBot GitHub page."
    )
